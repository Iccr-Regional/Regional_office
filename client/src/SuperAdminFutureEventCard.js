...
function SuperAdminFutureEventCard(props) {
  ...
  return (
    <div className="card shadow bg-light h-100">
      ...
      <div className="card-body">
        ...
        <Link to={{pathname:`/superadmin/futureevent/${eid}`, state:{event: props.futureEvent}}} className="stretched-link"></Link>
      </div>
    </div>
  );
}

export default SuperAdminFutureEventCard;