...
function SuperAdminCurrentEventCard(props) {
  ...
  return (
    <div className="card shadow bg-light h-100">
      ...
      <div className="card-body">
        ...
        <Link to={{pathname:`/superadmin/currentevent/${eid}`,state:{event: props.currentEvent} }} className="stretched-link"></Link>
...
export default SuperAdminCurrentEventCard;