...
function AdminRegionalOfficeCard(props) {
  ...
  return (
    <div className="card shadow h-100 gradiating-1">
      ...
      <div className="card-body">
        ...
        <Link to={{pathname:`/admin/regionaloffice/${rid}`, state: {office: props.regionalOffice}}} className="stretched-link"></Link>
      </div>
    </div>
  );
}

export default AdminRegionalOfficeCard;