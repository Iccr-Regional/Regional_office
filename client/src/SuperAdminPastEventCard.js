...
function SuperAdminPastEventCard(props) {
  ...
  return (
    <div className="card shadow bg-light h-100">
      ...
      <div className="card-body">
        ...
        <Link to={{pathname:`/superadmin/pastevent/${eid}`,state:{event: props.pastEvent}}} className="stretched-link"></Link>
      </div>
    </div>
  );
}

export default SuperAdminPastEventCard;