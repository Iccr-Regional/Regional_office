...
import AdminPastEventCard from "./AdminPastEventCard";
...
function AdminRegionalEvents(props) {
        ...
        return (
          ...
          <div>
            ...
            <div className="my-5 text-right">
              <Link to={{  pathname: "/admin/allfutureevents",  state: sortedFutureEvents }}>
              <button
                      type="submit"
                ...
                <div className="row d-flex justify-content-around my-5 pt-3">
                    {sortedPastEvents.slice(0,2).map((pastEvent) => (
                        <div key={pastEvent.eid} className="col-12 col-md-5 my-2">
                            <AdminPastEventCard pastEvent={pastEvent} />
                        </div>
                    ))}
                </div>
                <div className="my-5 text-right">
                <Link to={{  pathname: "/admin/allpastevents",  state: sortedPastEvents }}>
                <button
                      type="submit"
                      className="btn btn-dark align-items-right"
                      style={{ backgroundColor: "black" }}
...
export default AdminRegionalEvents;